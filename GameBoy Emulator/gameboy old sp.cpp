...
GameBoy::GameBoy(const char* rom_filename, Input *inputPtr)
{
	this->Init(rom_filename);
	input = inputPtr;
}

void GameBoy::Init(const char* rom_filename) {
	...
	if (io_map->LY >= 144) {		//Mode 1: (Vblank)
		...
		if (registers.sl_cnt <= 204) {
			...
			if (registers.sl_cnt > 400) {
				...
				if (io_map->LY == 143) {
					renderer->UpdateGraphics(frameStat);
				}
			}
...
void GameBoy::feedRenderer(Renderer* renderer) {
...
int GameBoy::nextInstruction() {
	...
	else cycles += 1;		//lcd and the timer still needs the clock to work

	handleSerial();
	handleJoypad();
	handleTimer(cycles);
	this->screenUpdate(cycles * 4);
	this->sound->UpdateSound(this->io_map);

	//limits gameboy speed
	time_clock += cycles * 4;
	if (time_clock >= 4200) {
		time_clock = 0;
		joypadStatus = input->getJoypadState();		//get joypad state every ~1ms
		if (joypadStatus.saveStatus) {
			cart->saveState();
		}
	...
	if (this->registers.IME && (this->io_map->IF & this->io_map->IE)) {
		...
		for (int i = 0; i < 5; i++) {
			if ((this->io_map->IF & (0x1 << i)) && (this->io_map->IE & (0x1 << i))) {
				...
				//PUSH PC
				write(this->registers.sp, (this->registers.pc>>8) & 0xff);
				write(this->registers.sp - 1, this->registers.pc & 0xff);
				this->registers.sp -= 2;
...
//serial registers are ignored
void GameBoy::handleSerial(void) {

	this->io_map->SB = 0xff;	//clear serial data
	this->io_map->SC = 0x00;	//clear serial control
}
...
int GameBoy::execute() {
	...
	case 0x27:		//DAA
	{
		...
		if (this->registers.flag.n) {		//subtraction in last math instruction
			...
			//4 lower nibbles greater than 9
			if (((a & 0xf) > 9) || this->registers.flag.h) {
				this->registers.flag.c |= (((uint16_t)this->registers.a + 6) > 0xff);
				this->registers.a += 6;
			}
	...
	case 0x80:		//ADD A, B
	{
		uint16_t sum = this->registers.a + this->registers.b;
		this->registers.flag.h = (((this->registers.a & 0xf) + (this->registers.b & 0xf)) > 0xf);
	...
	case 0x81:		//ADD A, C
	{
		uint16_t sum = this->registers.a + this->registers.c;

		this->registers.flag.h = (((this->registers.a & 0xf) + (this->registers.c & 0xf)) > 0xf);
		this->registers.a += this->registers.c;
		this->registers.flag.z = (this->registers.a == 0);
		this->registers.flag.n = 0;
		this->registers.flag.c = (sum > 0xff);
	...
	case 0x82:		//ADD A, D
	{
		uint16_t sum = this->registers.a + this->registers.d;

		this->registers.flag.h = (((this->registers.a & 0xf) + (this->registers.d & 0xf)) > 0xf);
		this->registers.a += this->registers.d;
		this->registers.flag.z = (this->registers.a == 0);
		this->registers.flag.n = 0;
		this->registers.flag.c = (sum > 0xff);
	...
	case 0x83:		//ADD A, E
	{
		uint16_t sum = this->registers.a + this->registers.e;

		this->registers.flag.h = (((this->registers.a & 0xf) + (this->registers.e & 0xf)) > 0xf);
		this->registers.a += this->registers.e;
		this->registers.flag.z = (this->registers.a == 0);
		this->registers.flag.n = 0;
		this->registers.flag.c = (sum > 0xff);
	...
	case 0x84:		//ADD A, H
	{
		uint16_t sum = this->registers.a + this->registers.h;

		this->registers.flag.h = (((this->registers.a & 0xf) + (this->registers.h & 0xf)) > 0xf);
		this->registers.a += this->registers.h;
		this->registers.flag.z = (this->registers.a == 0);
		this->registers.flag.n = 0;
		this->registers.flag.c = (sum > 0xff);
	...
	case 0x85:		//ADD A, L
	{
		uint16_t sum = this->registers.a + this->registers.l;

		this->registers.flag.h = (((this->registers.a & 0xf) + (this->registers.l & 0xf)) > 0xf);
		this->registers.a += this->registers.l;
		this->registers.flag.z = (this->registers.a == 0);
		this->registers.flag.n = 0;
		this->registers.flag.c = (sum > 0xff);
	...
	case 0x86:		//ADD A, (HL)
	{
		uint16_t hl = (this->registers.h << 8) | this->registers.l;
		uint8_t d = read(hl);
		uint16_t sum = this->registers.a + d;

		this->registers.flag.h = (((this->registers.a & 0xf) + (d & 0xf)) > 0xf);
	...
	case 0x87:		//ADD A
	{
		uint16_t sum = this->registers.a + this->registers.a;
		this->registers.flag.h = (((this->registers.a & 0xf) + (this->registers.a & 0xf)) > 0xf);
	...
	case 0x90:		//SUB B
	{
		this->registers.flag.h = ((this->registers.a & 0xf) < (this->registers.b & 0xf));
		this->registers.flag.c = (this->registers.a < this->registers.b);
	...
	case 0x91:		//SUB C
	{
		this->registers.flag.h = ((this->registers.a & 0xf) < (this->registers.c & 0xf));
		this->registers.flag.c = (this->registers.a < this->registers.c);
	...
	case 0x92:		//SUB D
	{
		this->registers.flag.h = ((this->registers.a & 0xf) < (this->registers.d & 0xf));
		this->registers.flag.c = (this->registers.a < this->registers.d);
	...
	case 0x93:		//SUB E
	{
		this->registers.flag.h = ((this->registers.a & 0xf) < (this->registers.e & 0xf));
		this->registers.flag.c = (this->registers.a < this->registers.e);
	...
	case 0x94:		//SUB H
	{
		this->registers.flag.h = ((this->registers.a & 0xf) < (this->registers.h & 0xf));
		this->registers.flag.c = (this->registers.a < this->registers.h);
	...
	case 0x95:		//SUB L
	{
		this->registers.flag.h = ((this->registers.a & 0xf) < (this->registers.l & 0xf));
		this->registers.flag.c = (this->registers.a < this->registers.l);
	...
	{
		if (!this->registers.flag.z) {
			this->registers.pc = (read(this->registers.sp + 1) | (read(this->registers.sp + 2) << 8));
			this->registers.sp += 2;
			return 5;
		}
	...
	case 0xc1:		//POP BC
	{
		this->registers.c = read(this->registers.sp + 1);
		this->registers.b = read(this->registers.sp + 2);
		this->registers.sp += 2;
		this->registers.pc += 1;
		return 3;
	}
	...
	case 0xc4:		//CALL NZ
	{
		if (!this->registers.flag.z) {
			...
			write(this->registers.sp, (ret_addr >> 8) & 0xff);
			write(this->registers.sp - 1, ret_addr & 0Xff);
	...
	case 0xc5:		//PUSH BC
	{
		write(this->registers.sp, this->registers.b);
		write(this->registers.sp - 1, this->registers.c);
		this->registers.sp -= 2;
		this->registers.pc += 1;
		return 4;
	}
	...
	{
		uint8_t n = read(pc + 1);
		uint16_t sum = this->registers.a + n;
		this->registers.flag.h = (((this->registers.a & 0xf) + (n & 0xf)) > 0xf);
		this->registers.a += n;
		this->registers.flag.z = (this->registers.a == 0);
		this->registers.flag.n = 0;
		this->registers.flag.c = (sum > 0xff);
	...
	case 0xd1:		//POP DE
	{
		this->registers.e = read(this->registers.sp + 1);
		this->registers.d = read(this->registers.sp + 2);
		this->registers.sp += 2;
		this->registers.pc += 1;
		return 3;
	}
	...
	case 0xd5:		//PUSH DE
	{
		write(this->registers.sp, this->registers.d);
		write(this->registers.sp - 1, this->registers.e);
		this->registers.sp -= 2;
		this->registers.pc += 1;
		return 4;
	}
	...
	case 0xe1:			//POP HL
	{
		this->registers.l = read(this->registers.sp + 1);
		this->registers.h = read(this->registers.sp + 2);
		this->registers.sp += 2;
		this->registers.pc += 1;
		return 3;
	}
	...
	case 0xe5:		//PUSH HL
	{
		write(this->registers.sp, this->registers.h);
		write(this->registers.sp - 1, this->registers.l);
		this->registers.sp -= 2;
		this->registers.pc += 1;
		return 4;
	}
	...
	case 0xf1:		//POP AF
	{
		*((uint8_t*)&this->registers.flag) = read(this->registers.sp + 1);
		this->registers.a = read(this->registers.sp + 2);
	...
	case 0xf5:		//PUSH AF
	{
		...
		write(this->registers.sp, this->registers.a);
		write(this->registers.sp - 1, flag);
		this->registers.sp -= 2;
		this->registers.pc += 1;
		return 4;
	}
...
int GameBoy::prefixed_execute() {
	...
	case 0x7c:		//BIT 7, H
	{
		if ((this->registers.h & 0x80) != 0)		//is set
			this->registers.flag.z = 0;
		else
			this->registers.flag.z = 1;
...
//copy the memory to dma region instantly
